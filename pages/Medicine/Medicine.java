...
public class Medicine extends JFrame {
    ...
    public void initAppLocation() {
        JLabel appLocation = new JLabel("Home/ Medicine");
        ...
        JLabel addButton = new JLabel(new ImageIcon("./pages/buttons/add.png"));
        addButton.setBounds(1054, 143, 123, 62);
        ...
        addButton.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                frame.dispose();
                new MedicineAdd().setVisible(true);
            }
    ...
    public void initCustomerListSection() {
        ...
        for (Med med : medList) { // Add a JPanel for each Med object to the medicineList
            ...
            if(medList.indexOf(med) == 0){
                ...
                JLabel medButton1 = new JLabel(new ImageIcon("./pages/buttons/edit.png"));
                medButton1.setCursor(new Cursor(Cursor.HAND_CURSOR));
                JLabel medButton2 = new JLabel(new ImageIcon("./pages/buttons/delete.png"));
                ...
                medButton2.addMouseListener(new MouseListener() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        frame.dispose();
                        MedicineCRUD.deleteMedicine(med.getId());
                        new Medicine()
                                .setVisible(true);
                ...
                buttonContainer.add(medButton1, BorderLayout.LINE_START);
                buttonContainer.add(medButton2, BorderLayout.LINE_END);
